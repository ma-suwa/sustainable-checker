...
export const institutions: Institution[] = [
  {
    ...
    detail:
      "2003年開始の悉皆調査。全上場企業のコーポレートサイト全体（IRに限らない）を対象に、客観的な掲載有無を1次50項目・2次168項目で調査し、3視点ごとの偏差値の平均を総合ポイントとする。レイアウトや文体などの主観的内容は評価対象外。2025年度は一部項目でAIによる調査結果を参考に使用。掲載率の例：決算説明会の動画配信43.8%、オンマウスのメニュー表示73.0%、統合報告書28.2%。",
