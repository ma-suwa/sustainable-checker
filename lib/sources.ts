...
// 出典の性格。出典一覧をこの順で見出し分けして示す。
export type SourceKind =
  | "ranking" // 第三者によるサイト評価・ランキング
  | "guideline" // 標準・ガイドライン（WCAG、GRI など）
  | "tool" // 計測ツール
  | "regulation"; // 制度・行政の指針

export const SOURCE_KIND_LABEL: Record<SourceKind, string> = {
  ranking: "サイト評価・ランキング（第三者評価）",
  guideline: "標準・ガイドライン",
  tool: "計測ツール",
  regulation: "制度・行政の指針",
};

export const SOURCE_KIND_DESC: Record<SourceKind, string> = {
  ranking:
    "第三者が公開している評価結果。項目数・配点・調査時期が公表されているものは、自社評価の物差しとして使える。",
  guideline:
    "評価項目の根拠となる標準・ガイドライン。改訂されるため、実際の評価では必ず最新版を確認する。",
  tool: "実際に計測して確かめるための公開ツール。誰でも同じ手順で再現できる。",
  regulation:
    "開示の前提となる制度・行政の指針。何が求められているかの下敷きになる。",
};
...
export interface SourceRef {
  ...
  year?: string; // 参照した版
  kind?: SourceKind; // 出典の性格（一覧の見出し分けに使う）
  image?: string; // 一次情報ページの画面例（public/ 配下）
}
...
export const sourceRegistry: Record<string, SourceRef> = {
  ...
  "gomez-ir": {
    ...
    kind: "ranking",
    image: "/screenshots/sites/src-gomez-ir.jpg",
  },
  "gomez-ir-2025-press": {
  ...
  "gomez-esg": {
    ...
    year: "2025（2025年9月発表）",
    kind: "ranking",
    image: "/screenshots/sites/src-gomez-esg.jpg",
  },
  ...
  "nikko-ir": {
    ...
    kind: "ranking",
    image: "/screenshots/sites/src-nikko-ir.jpg",
  },
  "nikko-ir-2025-pdf": {
  ...
  "daiwa-ir": {
    ...
    kind: "ranking",
    image: "/screenshots/sites/src-daiwa-ir.jpg",
  },
  "daiwa-ir-2025-pdf": {
  ...
  tribeck: {
    ...
    kind: "ranking",
    image: "/screenshots/sites/src-tribeck.jpg",
  },
  "tribeck-2026-press": {
  ...
  "wcag22-ja": {
    ...
    kind: "guideline",
    image: "/screenshots/sites/src-wcag22.jpg",
  },
  "nng-heuristics": {
    key: "nng-heuristics",
    ...
    kind: "guideline",
    image: "/screenshots/sites/src-nng-heuristics.jpg",
  },
  "core-web-vitals": {
    key: "core-web-vitals",
    ...
    kind: "guideline",
    image: "/screenshots/sites/src-core-web-vitals.jpg",
  },
  pagespeed: {
    key: "pagespeed",
  ...
  issb: {
    ...
    kind: "guideline",
    image: "/screenshots/sites/src-issb.jpg",
  },
  tcfd: {
    key: "tcfd",
  ...
  "ghg-protocol": {
    ...
    kind: "guideline",
    image: "/screenshots/sites/src-ghg-protocol.jpg",
  },
  gri: {
    key: "gri",
    label: "GRIスタンダード",
    ...
    kind: "guideline",
    image: "/screenshots/sites/src-gri.jpg",
  },
  sbti: {
    key: "sbti",
  ...
  "cg-code": {
    ...
    kind: "regulation",
    image: "/screenshots/sites/src-cg-code.jpg",
  },
  "fsa-disclosure": {
    key: "fsa-disclosure",
